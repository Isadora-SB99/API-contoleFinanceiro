...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                //.antMatchers(HttpMethod.PUT, "/usuarios/*").hasAuthority("ADMIN")//APENAS ADMIN E O PROPRIO USUARIO
                //.antMatchers(HttpMethod.DELETE, "/usuarios/*").hasAuthority("ADMIN")//APENAS ADMIN E O PROPRIO USUARIO
